"""
Django settings for raver_43421 project.
...
WSGI_APPLICATION = 'raver_43421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raver_43421 API",
    "DESCRIPTION": "API documentation for raver_43421 App",
    "VERSION": "v1",
}
